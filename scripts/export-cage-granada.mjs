/**
 * Genera fixtures/cage-eas-granada.csv desde los microdatos EAS.
 *
 * Extrae las columnas de consumo de alcohol (CAGE) de la Encuesta Andaluza
 * de Salud (EAS) filtrando por la provincia de Granada (PROV = 18.0).
 *
 * Decisión de diseño:
 ...
 *
 * Uso:
 *   node scripts/export-cage-granada.mjs
 *
...
const OUTPUT = resolve(_dir, '..', 'fixtures', 'cage-eas-granada.csv')
...
console.log(`
=== Exportación CAGE-EAS Granada ===
Fuente:     EAS_COMPLETO.csv
Filtro:     PROV=${PROV_GRANADA} (Granada)
Destino:    fixtures/cage-eas-granada.csv
