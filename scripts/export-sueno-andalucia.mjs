/**
 * Genera fixtures/sueno-eas-andalucia.csv desde los microdatos EAS.
 *
 * Extrae las columnas de sueño de la Encuesta Andaluza de Salud (EAS)
 * sin filtrar por provincia: Andalucía completa.
 *
 * Decisión de diseño:
 ...
 *
 * Uso:
 *   node scripts/export-sueno-andalucia.mjs
 *
...
const OUTPUT = resolve(_dir, '..', 'fixtures', 'sueno-eas-andalucia.csv')
...
console.log(`
=== Exportación Sueño EAS Andalucía ===
Fuente:     EAS_COMPLETO.csv
Filtro:     ninguno — Andalucía completa
Destino:    fixtures/sueno-eas-andalucia.csv
