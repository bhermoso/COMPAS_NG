...
| Actor model del estado `"approved"` del PSL | ✅ Completado (Sprint 2) | CONTRACT-INSTITUTIONAL-LIFECYCLE |
...
| `UnaddressedNeed[]` en `ActionPlanDraft` (G-PLS-7) | ✅ Soporte de dominio completado (2026-09-24); captura UI completa pendiente | `PlanPreparationDraft.unaddressedNeeds`, `PlanDocument.unaddressedNeeds` |
| `PLSEvaluationFramework` (marco de evaluación, G-PLS-10) | ✅ Tipo canónico y transporte documental completados (2026-09-24); captura UI completa pendiente | `PLSEvaluationFramework`, `PlanPreparationDraft.evaluationFramework`, `PlanDocument.evaluationFramework` |
